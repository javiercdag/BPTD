...
void ATDCharacter::NotifyControllerChanged()
{
...
void ATDCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATDCharacter::Move);
...
void ATDCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
